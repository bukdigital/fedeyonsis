        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-2 text-end animation-modal">
                    <a href="{{route('admin.user.create')}}" class="btn btn-primary waves-effect waves-light">YENİ EKLE</a>
                            ...
                            <tr>
                                ...
                                <td style="width: 10%;">
                                    <div class="d-flex order-actions button-items">
                                        ...
                                        <a href="{{ route('admin.user.edit', ['id' => $item->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Düzenle" class="btn btn-outline-purple waves-effect waves-light">
...
@push('js')
        ...
        <script>
            $(document).on('click', '.btn-detail', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.user.detail', ['id' => ':id']) }}".replace(':id', id),
                    type: 'GET',
            ...
            swalWithBootstrapButtons
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        // ID'yi forma ekle
                        $('#deleteForm').attr('action', `/admin/user/delete/${kisiID}`); // Action'ı güncelle
